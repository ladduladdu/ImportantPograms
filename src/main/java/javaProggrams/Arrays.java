...
public class Arrays {
	public static void main(String[] args) {
		...
		/*
		 * String[] str="thunder storm".split("t", 2); String stReplaceWord=""; int j=1;
		 * for (int i =0; i < str.length; i++) { stReplaceWord=str[i].replace("t",
		 * Integer.toString(j)); System.out.println(stReplaceWord); j++; }
		 */
